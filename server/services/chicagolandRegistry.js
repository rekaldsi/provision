...
const CHICAGOLAND_STORES = {
  walmart: { zips: ['60601', '60614', '60640', '60641', '60803', '60126'], name: 'Walmart' },
  target: { storeIds: ['T-0274', 'T-0596', 'T-2707'], name: 'Target' },
  homedepot: { storeIds: ['1909', '1912', '1918', '1919'], name: 'Home Depot' },
...
// Primary ZIP for deal sourcing (Jerry's neighborhood)
const PRIMARY_ZIP = '60641';

module.exports = { CHICAGOLAND_STORES, PRIMARY_ZIP };
